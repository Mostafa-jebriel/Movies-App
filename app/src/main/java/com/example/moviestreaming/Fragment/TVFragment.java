...
import com.example.moviestreaming.databinding.FragmentTVBinding;
...
public class TVFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        t=FragmentTVBinding.inflate(getLayoutInflater());
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        new get_tv().execute("tv","4");
    }
    class get_tv extends AsyncTask<String,String,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                try {
                    ...
                    t.allTvList.setHasFixedSize(true);
                    t.allTvList.setLayoutManager(new GridLayoutManager(getActivity(), 2));
                    t.allTvList.setAdapter(moveAdapter);
