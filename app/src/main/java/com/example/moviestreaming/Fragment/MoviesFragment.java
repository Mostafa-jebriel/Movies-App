...
import com.example.moviestreaming.databinding.FragmentMoviesBinding;
...
public class MoviesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        m=FragmentMoviesBinding.inflate(getLayoutInflater());
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                try {
                    ...
                    m.allMoviesList.setHasFixedSize(true);
                    m.allMoviesList.setLayoutManager(new GridLayoutManager(getActivity(), 2));
                    m.allMoviesList.setAdapter(moveAdapter);
